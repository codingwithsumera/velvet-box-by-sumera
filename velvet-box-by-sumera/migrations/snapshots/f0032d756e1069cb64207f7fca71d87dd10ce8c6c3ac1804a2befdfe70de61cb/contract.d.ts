...
export type StorageHash =
  StorageHashBase<'f0032d756e1069cb64207f7fca71d87dd10ce8c6c3ac1804a2befdfe70de61cb'>;
export type ExecutionHash =
  ExecutionHashBase<'fb8b2aac10d3727686e36641e94db75d91fded565734edaf254ddbf0b5e6ac75'>;
...
export namespace Models {
  ...
  export type public_Product = {
    ...
    readonly [RelationKeys]?: 'category' | 'collection';
  };
          ...
          readonly table: {
            ...
            readonly product: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'product_collectionId_idx_b344fc1a';
                  readonly prefix: 'product_collectionId_idx';
